...
object JSONDataSource {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 创建学生成绩DataFrame
    val studentScoresDF = sqlContext.read.json("hdfs://192.168.100.135:9000/spark-study/students.json")
    ...
    goodStudentsDF.write.format("json").save("hdfs://192.168.100.135:9000/spark-study/good-students-scala")
  }
