...
public class WindowHotWord {
    ...
    public static void main(String[] args) {
        ...
        // leo searchs
        // tom word
        final JavaReceiverInputDStream<String> searchLogsDStream =jssc.socketTextStream("hadoop01",9999);

        // 将搜索日志给转换成，只有一个搜索词，即可
        JavaDStream<String> searchWordDStream = searchLogsDStream.map(new Function<String, String>() {
        ...
        JavaPairDStream<String, Integer> searchWordPairDStream = searchWordDStream.mapToPair(
        ...
        JavaPairDStream<String,Integer> finalDStream = searchWordCountsDStream.transformToPair(
                ...
                new Function<JavaPairRDD<String, Integer>, JavaPairRDD<String,Integer>>() {
                    public JavaPairRDD<String, Integer> call(JavaPairRDD<String, Integer> searchWordCountsRDD) throws Exception {
                        ...
                        // 然后再执行反转，变成（searchWord，count）的这种格式
        ...
        // 这个无关紧要，只是为了出发jon的执行，所以必须有output操作
        finalDStream.print();
