...
public class TransformBlacklist {
    public static void main(String[] args) {
        ...
        // 这里的日志格式，就简化一下，就是data username的方式
        JavaReceiverInputDStream<String> adsClickLogDStream = jssc.socketTextStream("hadoop01",9999);
        ...
        JavaDStream<String> validAdsClickLogDStream = userAdsClickLogDStream.transform(
                new Function<JavaPairRDD<String, String>, JavaRDD<String>>() {
                    public JavaRDD<String> call(JavaPairRDD<String, String> userAdsClickLogRDD) throws Exception {
                        ...
                        // 也还是会被保存下来的
                        // (username, date username) leftOuterJoin (username, boolean)  得到 JavaPairRDD<String, Tuple2<String, Optional<Boolean>>>
                        ...
                        // 进行map操作，转换成我们想要的格式
                        JavaRDD<String> validAdaClickLogRDD = filteredRDD.map(
